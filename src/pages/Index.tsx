...
const features = [
  {
    ...
    description: 'All vaccines from certified manufacturers with full batch traceability',
  },
  {
    icon: Snowflake,
    title: 'Cold Chain Integrity',
    description: 'Temperature-controlled logistics ensuring vaccine efficacy',
  },
  {
    icon: Truck,
    title: 'Flexible Delivery',
    description: 'Schedule deliveries up to 90 days in advance for your vaccination campaigns',
  },
  {
    icon: BarChart3,
    title: 'Demand Forecasting',
    description: 'Plan your inventory with our advanced order forecasting tools',
  },
];

const stats = [
  { value: '50+', label: 'Vaccine Products' },
        ...
        <div className="container-main relative py-20 lg:py-32">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-sm font-medium mb-6">
              ...
              Trusted by 500+ veterinary professionals
            </div>
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Premium poultry and swine vaccines with guaranteed cold chain integrity. 
              Order today, schedule delivery for when you need it.
            </p>
